DROP TABLE IF EXISTS dimensions_of_products;
...
CREATE TABLE dimension_product (
    dp_id INTEGER NOT NULL AUTO_INCREMENT,
    dp_product INT NOT NOT NULL,
